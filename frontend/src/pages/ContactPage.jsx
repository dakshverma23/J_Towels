...
export default function ContactPage() {
  ...
  return (
    <div ref={rootRef}>
      ...
      <section className="ven-container max-w-2xl pb-24">
        <Form layout="vertical" onFinish={onFinish} className="ven-reveal border border-ven-line bg-white p-8 md:p-12">
          ...
          <Button htmlType="submit" className="ven-btn w-full md:w-auto">
            Send Message
          </Button>
        </Form>
      </section>
